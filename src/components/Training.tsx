...
const Training = () => (
  <section className="py-14 bg-[#1A1F2C]/80 flex justify-center">
        ...
        <CardContent className="p-6">
          ...
          <div className="w-full mb-6">
            <img
              ...
              className="w-full rounded-lg shadow-lg object-contain max-h-80 border-2 border-purple-500 bg-black"
            />
          </div>
